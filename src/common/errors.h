...
class AggregationIllegalError : public RMDBError {
    public:
    AggregationIllegalError() : RMDBError("Select query with illegal aggregation conditions") {}
};

class SubqueryIllegalError : public RMDBError {
    public:
    SubqueryIllegalError(const std::string & err_msg) : RMDBError("Subquery illegal: " + err_msg) {}
};

class NullptrError : public RMDBError {
    public:
    NullptrError() : RMDBError("Try to access nullptr") {}
};