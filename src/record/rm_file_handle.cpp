 ...
 * @note 该函数调用fetch_page进行pin操作，调用者需要调用unpin_page进行unpin操作
 */
// RmPageHandle RmFileHandle::fetch_page_handle(int page_no) const {
RmPageHandle RmFileHandle::FetchPageHandle(page_id_t page_id) const {
  // Todo:
  ...
  //     // throw InternalError("RmFileHandle::fetch_page_handle Error: Invalid page number.");
  //   }
  ...
  //   if (page == nullptr) {
  //     throw InternalError("RmFileHandle::fetch_page_handle Error: Failed to fetch page");
  //   }
 ...
 * @note 该函数调用new_page进行pin操作，调用者需要调用unpin_page进行unpin操作；
...
RmPageHandle RmFileHandle::create_new_page_handle() {
  ...
  //   if (new_page == nullptr) {
  //     throw InternalError("RmFileHandle::create_new_page_handle Error: Failed to create new page");
  //   }
