 ...
 */
FrameHeader::FrameHeader(frame_id_t frame_id) : frame_id_(frame_id), data_(PAGE_SIZE, 0) { Reset(); }
 ...
 */
auto BufferPoolManager::NewPage() -> page_id_t { UNIMPLEMENTED("TODO"); }
 ...
 */
auto BufferPoolManager::FlushPage(page_id_t page_id) -> bool { UNIMPLEMENTED("TODO"); }
 ...
 * TODO(P1): Add implementation
 */
void BufferPoolManager::FlushAllPages() { UNIMPLEMENTED("TODO"); }
