...
class Value {
 ...
 public:
   ...
   * @return true 如果两个值相等
   */
  inline auto operator==(const Value &o) const -> bool {
    return CompareEquals(o) == CmpBool::CmpTrue;
  }
   ...
   */
  inline auto operator!=(const Value &o) const -> bool {
    return CompareNotEquals(o) == CmpBool::CmpTrue;
  }
   ...
   */
  inline auto operator<(const Value &o) const -> bool {
    return CompareLessThan(o) == CmpBool::CmpTrue;
  }
   ...
   */
  inline auto operator<=(const Value &o) const -> bool {
    return CompareLessThanEquals(o) == CmpBool::CmpTrue;
  }
   ...
   */
  inline auto operator>(const Value &o) const -> bool {
    return CompareGreaterThan(o) == CmpBool::CmpTrue;
  }
   ...
   */
  inline auto operator>=(const Value &o) const -> bool {
    return CompareGreaterThanEquals(o) == CmpBool::CmpTrue;
  }
   ...
   * @return 反序列化的值
   */
  inline static auto DeserializeFrom(const char *storage, const Schema *schema,
...
// template <typename T>
// struct fmt::formatter<T, std::enable_if_t<std::is_base_of<easydb::Value,
// T>::value, char>>
...
// std::enable_if_t<std::is_base_of<easydb::Value, T>::value, char>>
//     : fmt::formatter<std::string> {
//   template <typename FormatCtx>
