...
class Transaction {
 public:
   ...
   */
  inline void AppendWriteRecord(WriteRecord *write_record) {
   ...
   */
  inline std::shared_ptr<std::deque<Page *>> GetIndexDeletedPageSet() {
   ...
   */
  inline void AppendIndexDeletedPage(Page *page) {
   ...
   */
  inline std::shared_ptr<std::deque<Page *>> GetIndexLatchPageSet() {
   ...
   */
  inline void AppendIndexLatchPageSet(Page *page) {
   ...
   */
  inline std::shared_ptr<std::unordered_set<LockDataId>> GetLockSet() {
    return lock_set_;
  }
