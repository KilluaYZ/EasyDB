  ...
  void CreateExtendibleHashIndex(const std::string &filename,
    ...
    // Create directory bucket page and write to file
    {
      ...
      *phdr = {.next_free_page_no = IX_NO_PAGE,
      ...
      // tp_rids[0] = {.page_id_ = IX_INIT_BUCKET_0_PAGE, .slot_num_ =
      // IX_NO_PAGE};  // only page_no is valid tp_rids[1] = {.page_id_ =
      // IX_INIT_BUCKET_1_PAGE, .slot_num_ = IX_NO_PAGE};  // only page_no is
      // valid
