...
execute "SELECT * FROM supplier, customer where S_SUPPKEY < 1000 AND C_CUSTKEY < 1000 AND S_PHONE = C_PHONE;"

print_green "==> varchar上进行单条件等值连接"
execute "SELECT * FROM supplier, customer where S_SUPPKEY < 1000 AND C_CUSTKEY < 1000 AND S_NAME = C_NAME;"
...
execute "SELECT * FROM supplier, customer where S_SUPPKEY < 1000 AND C_CUSTKEY < 1000 AND S_PHONE != C_PHONE AND S_SUPPKEY != C_CUSTKEY;"

print_green "=> 三表连接"
execute "SELECT S_NAME, C_NAME, N_NAME FROM supplier, customer, nation where S_SUPPKEY < 1000 AND C_CUSTKEY < 1000 AND S_NATIONKEY = N_NATIONKEY AND C_NATIONKEY = N_NATIONKEY;"

print_green "=> 两表卡氏积连接"
execute "SELECT * FROM supplier, customer where S_SUPPKEY < 1000 AND C_CUSTKEY < 1000;"
...
print_green "未开优化"
execute "SET enable_optimizer = false;"
execute "$1"

print_green "开优化"
execute "SET enable_optimizer = true;"
execute "$1"
